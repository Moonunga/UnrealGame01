...
#include "UnrealGame001/Public/Actors/BaseBullet.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	UNREALGAME001_API UClass* Z_Construct_UClass_ABaseBullet();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseBullet_Statics::NewProp_Collision_MetaData[] = {
		{ "Category", "BaseBullet" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseBullet_Statics::NewProp_Collision = { "Collision", nullptr, (EPropertyFlags)0x0020080000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseBullet, Collision), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Collision_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Collision_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseBullet_Statics::NewProp_Movement_MetaData[] = {
		{ "Category", "BaseBullet" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseBullet_Statics::NewProp_Movement = { "Movement", nullptr, (EPropertyFlags)0x0020080000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseBullet, Movement), Z_Construct_UClass_UProjectileMovementComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Movement_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Movement_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseBullet_Statics::NewProp_Mesh_MetaData[] = {
		{ "Category", "BaseBullet" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseBullet_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x0020080000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseBullet, Mesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseBullet_Statics::NewProp_Mesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABaseBullet_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseBullet_Statics::NewProp_Collision,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseBullet_Statics::NewProp_Movement,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseBullet_Statics::NewProp_Mesh,
	};
	...
	IMPLEMENT_CLASS(ABaseBullet, 2758901854);
	template<> UNREALGAME001_API UClass* StaticClass<ABaseBullet>()
	{
		return ABaseBullet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABaseBullet(Z_Construct_UClass_ABaseBullet, &ABaseBullet::StaticClass, TEXT("/Script/UnrealGame001"), TEXT("ABaseBullet"), false, nullptr, nullptr, nullptr);
